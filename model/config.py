...
class Config:
    ...
    def set_defaults(self):
        ...
        self.READER_NUM_PARALLEL_BATCHES = 13
        self.SHUFFLE_BUFFER_SIZE = 1000
        self.CSV_BUFFER_SIZE = 100 * 512 * 512  # 100 MB
        self.MAX_TO_KEEP = 10

        # model hyper-params
        self.MAX_CONTEXTS = 300
        self.MAX_TOKEN_VOCAB_SIZE = 22394
        self.MAX_TARGET_VOCAB_SIZE = 278
        self.MAX_PATH_VOCAB_SIZE = 1300000
